  ...
  return (
    <Card className="reveal-up border-accent/45 bg-panel-strong">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">Latest recommendation</p>
          ...
          <CardDescription className="mt-1 text-xs text-slate-200">
            As of {signal.asOfDate} · model {signal.modelVersion}
          </CardDescription>
        </div>
        ...
        <div className="min-w-[200px] border border-border bg-panel p-3 text-right">
          ...
          <p className="font-mono text-[11px] text-muted">Decision threshold {signal.threshold.toFixed(2)}</p>
